-- Quatro colunas novas na tabela de diagnostico do reconhecimento.
--
...
--   ms_captura_p50             so o custo de tirar o frame da camera
--
...
ALTER TABLE diagnostico_reconhecimento
  ...
  ADD COLUMN IF NOT EXISTS ms_captura_p50 integer;
